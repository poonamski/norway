...
const { getJobData, getJobSchema, TOTAL_JOBS, jobTitles, companies, norwayLocations, industries } = require('./jobData');
...
nav{background:#003087;color:#fff;padding:0 1.5rem;display:flex;align-items:center;justify-content:space-between;height:60px;position:sticky;top:0;z-index:100}
...
.hero{background:linear-gradient(135deg,#003087 0%,#002266 50%,#001144 100%);color:#fff;padding:3rem 1.5rem;text-align:center}
...
.search-bar input:focus,.search-bar select:focus{border-color:#003087}
...
.filter-chip.active,.filter-chip:hover{background:#003087;color:#fff;border-color:#003087}
...
.job-card:hover{border-color:#003087;transform:translateY(-2px)}
...
.btn-apply{padding:.55rem 1.3rem;background:#003087;color:#fff;border:none;border-radius:8px;font-weight:700;font-size:.85rem;cursor:pointer;transition:background .2s}
.btn-apply:hover{background:#001a4a}
...
.btn-apply-big{padding:.85rem 2.5rem;background:#003087;color:#fff;border:none;border-radius:10px;font-weight:700;font-size:1rem;cursor:pointer;transition:background .2s}
.btn-apply-big:hover{background:#001a4a}
...
.pagination a:hover{border-color:#003087;color:#003087}
...
.breadcrumb a{color:#003087}
.info-box{background:#fff;border-radius:12px;padding:1.25rem 1.5rem;border-left:4px solid #003087;margin-bottom:1rem;font-size:.88rem}
...
.modal input:focus{border-color:#003087}
.modal .btn-submit{width:100%;padding:.75rem;background:#003087;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer;font-size:.95rem}
.modal .btn-submit:hover{background:#001a4a}
...
${AD_TOP}
<nav>
  <a class="brand" href="/"><span>NO</span>RWAY<span>.jobs</span></a>
  <div class="nav-links">
    <a href="/">Home</a>
...
${AD_BOTTOM}
<footer>
  &copy; 2025 NORWAY.jobs — <strong>100,000 Jobs</strong> across Norway |
...
<div class="job-card">
  ...
  const body = `
<div class="hero">
  <h1>Find Your Dream Job in <span class="accent">Norway</span></h1>
  <p>100,000 verified job listings — remote & on-site — across all 11 counties</p>
  ...
  <div class="stat-bar">
    ...
    <div class="stat"><strong>11</strong><span>Counties</span></div>
...
<div class="container">
  <div class="info-box">
    🇳🇴 Norway's most comprehensive job board — browse <strong>50,000 remote jobs</strong> and <strong>50,000 on-site jobs</strong> across all industries.
  </div>
   ${AD_MIDDLE}
...
<div class="hero" style="padding:1.75rem 1.5rem">
  <h1 style="font-size:1.8rem">Browse <span class="accent">100,000 Jobs</span> in Norway</h1>
...
<div class="container">
  ...
  <div class="job-detail">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:1rem">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:.5rem">
        ...
        <span style="font-size:.8rem;color:#888">Job ID: NO-${String(job.id).padStart(6, '0')}</span>
      </div>
    </div>
  ...
  <div style="text-align:center;margin-top:1.5rem">
    <a href="/jobs" style="color:#003087;font-weight:600">← Browse All 100,000 Jobs</a>
  </div>
</div>`;
...
app.get('/sitemap', (req, res) => {
  const body = `
<div class="container">
  <h1 style="margin-bottom:1rem">Sitemap — NORWAY.jobs</h1>
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1rem">
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/" style="color:#003087">🏠 Home</a>
        <a href="/jobs" style="color:#003087">📋 All Jobs (100,000)</a>
        <a href="/jobs?type=remote" style="color:#003087">🌐 Remote Jobs (50,000)</a>
        <a href="/jobs?type=onsite" style="color:#003087">🏢 On-site Jobs (50,000)</a>
      </div>
    </div>
    <div class="job-card">
      <div class="card-title">XML Sitemaps</div>
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/sitemap.xml" style="color:#003087">📄 Sitemap Index</a>
        <a href="/sitemap-1.xml" style="color:#003087">📄 Sitemap 1 (Jobs 1–1,000)</a>
        <a href="/sitemap-2.xml" style="color:#003087">📄 Sitemap 2 (Jobs 1,001–2,000)</a>
    ...
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/jobs/1" style="color:#003087">Job #1 (First Remote Job)</a>
        <a href="/jobs/50000" style="color:#003087">Job #50,000 (Last Remote Job)</a>
        <a href="/jobs/50001" style="color:#003087">Job #50,001 (First On-site Job)</a>
        <a href="/jobs/100000" style="color:#003087">Job #100,000 (Last On-site Job)</a>
      </div>
    </div>
  </div>
</div>`;
